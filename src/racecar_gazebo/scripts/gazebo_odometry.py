...
class OdometryNode:
    ...
    def __init__(self):
        ...
        # Set subscribers
 #       rospy.Subscriber('/odometry/filtered', Odometry , self.sub_robot_pose_update)
...
#       self.last_received_pose = msg.pose.pose
#       self.last_received_twist = msg.twist.twist
#       self.last_recieved_stamp = rospy.Time.now()
#	rospy.loginfo(msg)
#	rospy.loginfo("fucccccccccccccccccccccccccccccccccccccccccccccck")
